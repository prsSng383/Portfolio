  ...
  return (
    <div id='work' className='w-full px-[12%] py-10 scroll-mt-20'>
           ...
           <p className='text-center max-w-2xl mx-auto mt-5 mb-12'>
            ...
            <a href="#about" className='w-max flex items-center justify-center gap-2 text-gray-700 border-[0.5px] border-gray-700 rounded-full py-3 px-10 mx-auto my-20 hover:bg-[#fcf4ff] duration-500'>Show more <Image src={assets.right_arrow_bold} alt='arrow icon' className='w-4' /> </a>
