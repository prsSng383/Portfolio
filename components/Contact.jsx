...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "741df05e-21c2-47b9-8212-d1f59f180b37");
         ...
         <h4 className='text-center mb-2 text-lg'>
           ...
           <form onSubmit={onSubmit} className='max-w-2xl mx-auto'>
               <div className='grid grid-cols-2 gap-6 mt-10 mb-8'>
                  ...
                  <button type='submit' className='py-3 px-8 w-max flex items-center justify-between gap-2 bg-black/80 text-white rounded-full mx-auto hover:bg-black duration-500 cursor-pointer'>Submit now <Image src={assets.right_arrow_white} alt='arrow icon' className='w-4'/></button>
                   
                   <p className='mt-4 font-bold text-green-400'>{result}</p>
           </form>
    </div>
  )
}
